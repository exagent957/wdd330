...
function scheduleMeeting(startTime, durationMinutes) {
  var [meetingStartHour, meetingStartMinutes] =
    //do not understand this regular expression
    // found out \d is the same as [^0-9] inside{} represents number of characters to match {1,2} means match one or two characters
